...
でも書斎は、私のデスクでも夫のデスクでも速度を求めて基本的に有線LANを使うようにしている。それに無線LANに繋いでいたとしても、ブレーカーが落ちてモニタやカメラ、マイクの電源が切れればZoom会議からは強制退場になってしまうのだ。電源の上限を上げることも考えて、東京電力パワーグリッドに問い合わせてみたけれど、部屋単位の上限だけでなくマンションのフロア単位の上限もあるので気軽に上げることはできなさそうだった。
...
デスク周りで電源が必要なものは全部コンセントをUPSに挿してある。もちろんフットマッサージャー@<fn>{foot}も例外ではない。停電してもフットマッサージャーは動き続けるんだなぁ、と思うとちょっと面白い。
